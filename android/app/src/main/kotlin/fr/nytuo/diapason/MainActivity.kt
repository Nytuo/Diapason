...
class MainActivity : AudioServiceActivity() {
    companion object {
        private const val CLIENT_CERT_CHANNEL = "fr.nytuo.diapason/client_certificate"
        private const val CLIENT_CERT_CHANNEL_LOG_TAG = "ClientCertChannel"

        private const val DOWNLOADS_SERVICE_CHANNEL = "fr.nytuo.diapason/downloads_service"
        private const val DOWNLOADS_SERVICE_CHANNEL_LOG_TAG = "DownloadsServiceChannel"

        private const val OUTPUT_SWITCHER_CHANNEL = "fr.nytuo.diapason/output_switcher"
        private const val OUTPUT_SWITCHER_CHANNEL_LOG_TAG = "OutputSwitcherChannel"

        private const val SET_NATIVE_THEME_CHANNEL = "fr.nytuo.diapason/set_native_theme"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        VisualizerChannel(flutterEngine.dartExecutor.binaryMessenger)
        MethodChannel(
