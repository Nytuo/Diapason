...
Future<void> showModalHomeSectionMenu({
  ...
  // TODO build real home section playable
  final item = PlayableBaseItem(
    item: BaseItemDto(id: BaseItemId("dummy-home"), name: section.getTitle(context)),
    sortConfig: SortAndFilterConfiguration.defaultNonAlbumSort,
  );
